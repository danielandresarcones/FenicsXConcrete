...
from fenicsxconcrete.util import ConcreteHomogenization
...
def test_thermal_homogenization():
    ...
    homgenized_concrete_2 = ConcreteHomogenization(
        E_matrix=matrix_E,
        nu_matrix=matrix_poissions_ratio,
        fc_matrix=matrix_compressive_strength,
        kappa_matrix=matrix_thermal_conductivity,
    ...
    # adding uncoated
    homgenized_concrete_1.add_uncoated_particle(
        E=aggregate_E,
    ...
    # adding coated
    homgenized_concrete_2.add_coated_particle(
        E_inclusion=aggregate_E,
...
def test_stiffness_homogenization():
    ...
    # testing new code
    homgenized_concrete = ConcreteHomogenization(
        E_matrix=matrix_E, nu_matrix=matrix_poissions_ratio, fc_matrix=matrix_compressive_strength
    )
    # adding airpores
    homgenized_concrete.add_uncoated_particle(E=air_E, nu=matrix_poissions_ratio, volume_fraction=air_vol_frac)
    # adding agregates
    homgenized_concrete.add_coated_particle(
        E_inclusion=aggregate_E,
        nu_inclusion=aggregate_poissions_ratio,
        itz_ratio=itz_factor,
        radius=aggregate_radius,
...
def test_volume_averages():
    ...
    homgenized_concrete_1 = ConcreteHomogenization(
        E_matrix=E, nu_matrix=poissions_ratio, fc_matrix=compressive_strength, rho_matrix=matrix_rho, C_matrix=matrix_C
    )
    ...
    # adding uncoated
    homgenized_concrete_1.add_uncoated_particle(
        E=E, nu=poissions_ratio, volume_fraction=aggregate_vol_frac, rho=aggregate_rho, C=aggregate_C
    )
    # adding coated
    homgenized_concrete_2.add_coated_particle(
        E_inclusion=E,
...
def test_heat_release():
    ...
    homgenized_concrete = ConcreteHomogenization(
        E_matrix=E, nu_matrix=poissions_ratio, fc_matrix=compressive_strength, rho_matrix=rho, Q_matrix=Q
    )
